...
class ps_ece extends StatefulWidget {
  const ps_ece({super.key});

  @override
  State<ps_ece> createState() => _ps_eceState();
}

class _ps_eceState extends State<ps_ece> {
  late Future<List<FirebaseFile>> futureFiles;
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    futureFiles = FirebaseApi.listAll('pre_3/2022_pre/ece/ps/');
  }
