...
class mai_ece extends StatefulWidget {
  const mai_ece({super.key});

  @override
  State<mai_ece> createState() => _mai_eceState();
}

class _mai_eceState extends State<mai_ece> {
  late Future<List<FirebaseFile>> futureFiles;
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    futureFiles = FirebaseApi.listAll('pre_3/2022_pre/ece/mai/');
  }
