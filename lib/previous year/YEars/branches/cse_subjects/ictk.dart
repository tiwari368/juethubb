...
class ictk_cse extends StatefulWidget {
  const ictk_cse({super.key});

  @override
  State<ictk_cse> createState() => _ictk_cseState();
}

bool isLoading = false;

class _ictk_cseState extends State<ictk_cse> {
  late Future<List<FirebaseFile>> futureFiles;
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    futureFiles = FirebaseApi.listAll('pre_3/2022_pre/cse/ictk/');
  }
