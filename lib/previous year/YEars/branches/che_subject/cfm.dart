...
class cfm_che extends StatefulWidget {
  const cfm_che({super.key});

  @override
  State<cfm_che> createState() => _cfm_cheState();
}

class _cfm_cheState extends State<cfm_che> {
  late Future<List<FirebaseFile>> futureFiles;
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    futureFiles = FirebaseApi.listAll('pre_3/2022_pre/che/cfm/');
  }
