...
class cre_che extends StatefulWidget {
  const cre_che({super.key});

  @override
  State<cre_che> createState() => _cre_cheState();
}

class _cre_cheState extends State<cre_che> {
  late Future<List<FirebaseFile>> futureFiles;
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    futureFiles = FirebaseApi.listAll('pre_3/2022_pre/che/cre/');
  }
